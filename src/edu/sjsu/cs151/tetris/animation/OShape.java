...
public class OShape implements MoveableShape {
	...
	public void draw(Graphics2D g2) {
		...
		Rectangle2D.Double block3 = new Rectangle2D.Double(x, y + (width / 4), width / 4, width / 4);
		Rectangle2D.Double block4 = new Rectangle2D.Double(x + (width / 4), y + (width / 4), width / 4, width / 4);
